...
def solveQuery(matNum, player, lookfor, score, question):
			...
			if len(lookfor) == 1:
				...
				if score == 2:
					if player in bat_in1:
						for ball in com1:
							if com1[ball]['to'].lower() in player.lower():
								if com1[ball]['what']=='2 runs':
									answer.append(int(float(ball)))
					if player in bat_in2:
						for ball in com2:
							if com2[ball]['to'].lower() in player.lower():
								if com2[ball]['what']=='2 runs':
									answer.append(int(float(ball)))
				if score == 3:
					if player in bat_in1:
						for ball in com1:
							if com1[ball]['to'].lower() in player.lower():
								if com1[ball]['what']=='3 runs':
									answer.append(int(float(ball)))
					if player in bat_in2:
						for ball in com2:
							if com2[ball]['to'].lower() in player.lower():
								if com2[ball]['what']=='3 runs':
									answer.append(int(float(ball)))
				if score == 4:
					if player in bat_in1:
						for ball in com1:
							if com1[ball]['to'].lower() in player.lower():
								if com1[ball]['what']=='4 runs':
									answer.append(int(float(ball)))
					if player in bat_in2:
						for ball in com2:
							if com2[ball]['to'].lower() in player.lower():
								if com2[ball]['what']=='4 runs':
									answer.append(int(float(ball)))
				if score == 6:
					if player in bat_in1:
						for ball in com1:
							if com1[ball]['to'].lower() in player.lower():
								if com1[ball]['what']=='6 runs':
									answer.append(int(float(ball)))
					if player in bat_in2:
						for ball in com2:
							if com2[ball]['to'].lower() in player.lower():
								if com2[ball]['what']=='6 runs':
									answer.append(int(float(ball)))
